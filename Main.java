...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] labels = {"FREE PARKING", "Shatin HKD 700", "? CHANCE", "Tuen Mun HKD 400", "Tai Po HKD 500", "GO TO JAIL",
     "Tsing Yi HKD 400", "Sai Kung HKD 400",
      "? CHANCE", "Yuen Long HKD 400", 
      "Mong Kok HKD 500","? CHANCE",
    "Shek O HKD 400","Tai O HKD 600",
"IN JAIL JUST VISIT","Stanley HKD 600","INCOME TAX PAY 10%","Wan Chai HKD 700","CENTRAL HKD 800","GO"};
...
//set user
        ...
        controller.addToLocation(labels, functionData, rent,types,locationIndexs,mainCall.scanner);
